                      ...
                      <div className="container-fluid py-3">
                        {
                          dummypurchase.map((data, idx) => {
                            return (
                              <div className="row py-3 custom-border-bottom" key={"dummypurchase" + idx}>
                                <div className="col-6 d-flex align-items-center">
                                  <input className="small-checkbox" type="checkbox" name="" id="" />
                                  <div className="text-poppins text-dark-3 fs-14 fw-600 ps-3">{data.name}</div>
                                </div>
                                <div className="col-1">
                                  <div className="chip blue">
                                    ...
                                    <img width={7} src="./assets/vectors/chip-close-blue.svg" alt="" />
                                  </div>
                                </div>
                                <div className="col-2">
                        ...
                        <div className="row py-5">
                          <div className="col-12">
                            <div className="text-dark-3 text-manrope fw-800 fs-18">Purchase</div>
                          </div>
                        </div>
                        <div className="row gap-4">
                          <div className="col-4 custom-border-bottom d-flex flex-column gap-2">
                            <div className="text-light-5 text-manrope fs-14">Supplier</div>
                            <div className="text-dark-3 text-poppins fs-14 fw-700">CarQuest</div>
                          </div>
                          <div className="col-1 custom-border-bottom d-flex flex-column gap-2">
                            <div className="text-light-5 text-manrope fs-14">Date</div>
                            <div className="text-dark-3 text-poppins fs-14 fw-700">02-11-2022</div>
                          </div>
                          <div className="col-2 custom-border-bottom d-flex flex-column gap-2">
                            <div className="text-light-5 text-manrope fs-14">Refrence Number</div>
                            <div className="text-dark-3 text-poppins fs-14 fw-700">877346234</div>
                          </div>
                          <div className="col-1 custom-border-bottom d-flex flex-column gap-2">
                            <div className="text-light-5 text-manrope fs-14">Terms (days)</div>
                            <div className="text-dark-3 text-poppins fs-14 fw-700">14</div>
                          </div>
                          <div className="col-2 custom-border-bottom d-flex flex-column gap-2">
                            <div className="text-light-5 text-manrope fs-14">Payment Source</div>
                            <div className="text-dark-3 text-poppins fs-14 fw-700">Banking **7362</div>
                          </div>
                        </div>
                        <div className="container-fluid pt-5 px-0">
                          {
                            purchases.map((data, idx) => {
                              return (
                                <div className="row py-3 gx-0 align-items-center custom-border-bottom" key={"purchase" + idx}>
                                  <div className="col-3 col-lg-4">
                                    <div className="text-dark-3 fs-14 fw-800 text-poppins">{data.name}</div>
                                  </div>
                                  <div className="col-1">
                                    <div className="text-dark-3 text-manrope fs-12">{data.highPrice}$</div>
                                  </div>
                                  <div className="col-1">
                                    <div className="text-dark-3 text-manrope fs-12">{data.lowPrice}$</div>
                                  </div>
                                  <div className="col-2 d-flex justify-content-end pe-5">
                                    <div className="chip blue">
                                      ...
                                      <img src="./assets/vectors/chip-close-blue.svg" alt="" />
                                    </div>
                                  </div>
                                  <div className="col-2 col-lg-1">
                                    <div className="text-dark-3 text-manrope fs-12">{data.purchaseNo}</div>
                                  </div>
                                  <div className="col-1">
                                    <div className="text-dark-3 text-manrope fs-12">Qt. {data.quantity}</div>
                                  </div>
                                  <div className="col-2">
                                    <div className="text-dark-3 text-manrope fs-12">{data.purchaseId}</div>
                                  </div>
                                </div>
                              )
                            })
                          ...
                          <div className="row py-4 gx-0">
                            ...
                            <div className="col-1">
                              <div className="text-dark-3 text-manrope fw-800 fs-12">53,45$</div>
                            </div>
                            <div className="col-1">
                              <div className="text-dark-3 text-manrope fw-800 fs-12">23,45$</div>
                            </div>
                          </div>
                          <div className="row py-4 gx-0">
                            <div className="col-12 d-flex gap-3">
                              ...
                              <button onClick={() => setServiceBrakeSelected(false)} className={`btn padding blue`}>
                                Add Payment
                              </button>
                            </div>
                          </div>
